...
function seatClick() {
    ...
    if (this.classList.contains('reserved')==false) {
        ...
        if (this.classList.toggle('selected')) {
            $(".row").find('.a1.selected').nextUntil(".selected");
...
///////////////////////////////////////////
	...
	$(".show-menu").on("click", function () {
		$(".sidebar").addClass("sidebarvisible");
		$(".body-overlay").addClass("opened");
	});
	$(".body-overlay").on("click", function () {
	...
	$(".open-book").on("click", function(){
		$(".myIframe").toggleClass("displayframe");
		$(".full").toggleClass("newFull");
	})
	...
	// 	this.style.color = this.style.color === 'black' ? 'gray' : 'black';
	//   });


})(jQuery);
function myFunction() {
	var x = document.getElementById("toggleshow");
