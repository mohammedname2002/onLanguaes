...
@section('title','إنشاء نظام تربح')

@section('title_page','إنشاء نظام تربح')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">إنشاء نظام تربح</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">الصفحة الرئيسية</a></li>
                            <li class="breadcrumb-item active">إنشاء نظام تربح</li>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">إنشاء نظام تربح</h4>

                       <form action="{{route('admin.campaign.store')}}" method="POST" class="" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb3">
                           <div class="col-lg-6">
                            <label for="example-text-input" class="col-sm-4 col-form-label">عنوان نظام التربح بالعربي</label>
                            <div class="col-sm-10">
                                <input class="form-control {{$errors->has('title_ar')?'is-invalid':''}}" value="{{old('title_ar')}}" name="title_ar" type="text" placeholder="عنوان نظام التربح.." id="example-text-input">
                           ...
                           <div class="col-lg-6">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control {{$errors->has('title_en')?'is-invalid':''}}" value="{{old('title_en')}}" name="title_en" type="text" placeholder="عنوان نظام التربح.." id="example-text-input">
                        ...
                        <div class="row mb3">
                            <div class="col-lg-12">
                                <label for="example-text-input" class="col-sm-4 col-form-label">المميزات
                                    ...
                                    <textarea class="elm1 {{ $errors->has('feachers_ar') ? 'is-invalid' : '' }}" name="feachers_ar" class="form-control">{{old("feachers_ar")}}</textarea>
                            ...
                            <div class="col-lg-12 mt-2">
                                <label for="example-text-input" class="col-sm-2 col-form-label">المميزات
                                    ...
                                    <textarea class="elm1 {{ $errors->has('feachers_en') ? 'is-invalid' : '' }}" name="feachers_en"  class="form-control">{{old("feachers_en")}}</textarea>
                        ...
                        <div class="row mb3">
                            <div class="col-lg-4">
                                ...
                                <input class="form-control {{$errors->has('start_at')?'is-invalid':''}}" value="{{old('start_at')}}" name="start_at" type="date" id="example-text-input">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input class="form-control {{$errors->has('end_at')?'is-invalid':''}}" value="{{old('end_at')}}" name="end_at" type="date" id="example-text-input">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input class="form-control {{$errors->has('total_points')?'is-invalid':''}}" value="{{old('total_points')}}" name="total_points" type="text" id="example-text-input">
