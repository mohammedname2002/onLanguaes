...
@section('title')
    {{ trans('header_trans.contact_us') }}@endsection
...
@section('content')
    ...
    <main>
        <!-- hero-area-start -->
        <div class="hero-arera course-item-height" data-background="{{ asset('assets/user/img/slider/contact-us-figure.jpg')}}">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="hero-course-1-text">
                            <h2>{{ trans('header_trans.contact_us') }}</h2>
                        </div>
                        <div class="course-title-breadcrumb">
                            <nav>
                                <ol class="breadcrumb"  style="background: none">
                                    <li class="breadcrumb-item"><a href="{{ URL('/') }} ">{{ trans('header_trans.home') }}</a></li>
                                    <li class="breadcrumb-item"><span>{{ trans('header_trans.contact_us') }}</span></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-12">
                        <div class="contact-area-wrapper">
                            <div class="section-title mb-50">
                                <h2> {{ trans('contact_us_trans.keep') }}  </h2>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="contact-from-input mb-20">
                                    <input type="text "  name="name" placeholder="{{ trans('contact_us_trans.name') }}">
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="contact-from-input mb-20">
                                    <input type="text" name="phone"  placeholder="{{ trans('contact_us_trans.phone') }}" >
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="contact-from-input mb-20">
                                    <input type="email" name="email" placeholder="{{ trans('contact_us_trans.email') }}">
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="contact-from-input mb-20">
                                    <textarea  name="message" placeholder="{{ trans('contact_us_trans.message') }} "></textarea>
                                </div>
                            </div>
                            <div class="colxl-2 ">
                                <div class="cont-btn mb-20">
                                    <button class="cont-btn"> {{ trans('contact_us_trans.submit') }}</button>
                                </div>
                        ...
                        <div class="sidebar-widget-wrapper">
                            <div class="support-contact mb-30">
                                <div class="support-tittle">
                                    <h4>{{ trans('contact_us_trans.support_contact') }}</h4>
                                </div>
                                <div class="support-contact-inner">
                                    <div class="support-item">
                                        ...
                                        <div class="support-info-phone">
                                            <span>{{ trans('contact_us_trans.phone') }}</span>
                                            <p>Mobile :<a href="tel:{{ $settings['support_phone'] }}"> {{$settings['support_phone'] }}</a></p>
                                        </div>
                                    </div>
                                    <div class="support-item">
                                        <div class="support-icon">
                                        ...
                                        <div class="support-info-email">
                                            <span>{{ trans('contact_us_trans.email') }}</span>
                                            <a href="mailto:{{ $settings['support_email'] }}"><span class="__cf_email__" data-cfemail="b4f7dbdac0d5d7c0f4d1ccd5d9c4d8d19ad7dbd9" style="font-size: 12px">{{$settings['support_email'] }}
                                        ...
                                        <div class="support-info-location">
                                            <span>{{ trans('contact_us_trans.location') }}</span>
                                            {{ $settings['location'] }}
                                        </div>
                                    </div>
                                </div>
