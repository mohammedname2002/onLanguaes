            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">تعديل دورة</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">تعديل دورة</h4>
                            ...
                            <form action="{{ route('admin.course.update',$course->id) }}" method="POST" class="" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}"
                                                value="{{ $course->title_ar }}" name="title_ar" type="text"
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control {{ $errors->has('title_en') ? 'is-invalid' : '' }}"
                                                value="{{ $course->title_en }}" name="title_en" type="text"
                                ...
                                <div class="row mb3">
                                    <div class="col-lg-12">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">الوصف
                                            ...
                                            <textarea class="elm1 {{ $errors->has('description_ar') ? 'is-invalid' : '' }}" name="description_ar" class="form-control">{{$course->description_ar}}</textarea>
                                    ...
                                    <div class="col-lg-12 mt-2">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">الوصف
                                            ...
                                            <textarea class="elm1 {{ $errors->has('description_en') ? 'is-invalid' : '' }}" name="description_en"  class="form-control">{{$course->description_en}}</textarea>
                                ...
                                <div class="row mb3">
                                    <div class="col-lg-12">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">
                                            ...
                                            <textarea class="{{ $errors->has('meta_description') ? 'is-invalid' : '' }} form-control" name="meta_description">{{$course->meta_description}}</textarea>
                                    ...
                                    <div class="col-lg-12 mt-2">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">المميزات</label>
                                            ...
                                            <textarea class="{{ $errors->has('features') ? 'is-invalid' : '' }} form-control" name="features"  >{{$course->features}}</textarea>
                                ...
                                <div class="row mb3">
                                    <div class="col-lg-4">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">مدة الدورة</label>
                                            ...
                                            <input type="text" class="{{ $errors->has('duration') ? 'is-invalid' : '' }} form-control" name="duration"  value="{{$course->duration}}">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="date" class="{{ $errors->has('start_at') ? 'is-invalid' : '' }} form-control" name="start_at" value="{{$course->start_at->format('Y-m-d')}}">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="date" class="{{ $errors->has('end_at') ? 'is-invalid' : '' }} form-control" name="end_at"  value="{{$course->end_at->format('Y-m-d')}}">
                                ...
                                <div class="row mb3">
                                    <div class="col-lg-4">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">حالة الظهور</label>
                                            ...
                                            <select name="visiable" class="form-control" id="">
                                                <option value="1" {{$course->visiable=='1'?'selected':''}}>يظهر</option>
                                                <option value="0" {{$course->visiable=='0'?'selected':''}}>مخفي</option>
                                            </select>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="{{ $errors->has('preview') ? 'is-invalid' : '' }} form-control" name="preview"  value="{{$course->preview_video}}">
                                ...
                                <div class="row mb3">
                                    <div class="col-lg-4">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">نوع الدورة</label>
                                            ...
                                            <select name="type" class="{{ $errors->has('type') ? 'is-invalid' : '' }} form-control" id="">
                                                <option value="paid" {{$course->type=='paid'?'selected':''}}>مدفوع</option>
                                                <option value="free" {{$course->type=='free'?'selected':''}}>مجاني</option>
                                            </select>
                                            @if ($errors->has('type'))
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('type') }}
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text"  name="price" class="{{ $errors->has('price') ? 'is-invalid' : '' }} form-control" value="{{$course->price}}">
                                        ...
                                        <label for="example-text-input" class="col-sm-2 col-form-label">إسناد للغة</label>
                                            ...
                                            <select name="language" class="{{ $errors->has('language') ? 'is-invalid' : '' }} form-control" id="">
                                                ...
                                                @foreach ($languages as $lang)
                                                    <option value="{{$lang->id}}" {{$course->language_id==$lang->id?'selected':''}}>{{$lang->title_ar}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <label for="example-text-input" class="col-sm-2 col-form-label">المعلمين</label>
                                            <select id="teacher"  name="teachers[]" class="{{ $errors->has('teachers') ? 'is-invalid' : '' }} form-control select2" id="">
                                                @foreach ($course->teachers as $teacher)
                                                        <option value="{{$teacher->id}}" selected>{{$teacher->name_ar}}</option>
                                                @endforeach
                                            </select>
...
@push('js')
    ...
    <script src="{{asset('assets/admin/libs/select2/js/select2.min.js')}}"></script>
     <script>
        var teachersids=@json($course->teachers);

        teachersids=teachersids.map((i)=>i["id"]);
        $("#teacher").select2({
            multiple:true,
            ajax: {
      ...
      return {
        ...
        $("#teacher").val(teachersids).trigger('change')
    </script>
@endpush
