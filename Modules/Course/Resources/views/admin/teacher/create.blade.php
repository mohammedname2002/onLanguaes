        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">إضافة معلم</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">إضافة معلم</h4>
                       ...
                       <form action="{{route('admin.teacher.store')}}" method="POST" class="" enctype="multipart/form-data">
                        ...
                        <div class="row mb3">
                           <div class="col-lg-4">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control {{$errors->has('name_ar')?'is-invalid':''}}" value="{{old('name_ar')}}" name="name_ar" type="text" placeholder="الإسم.." id="example-text-input">
                           ...
                           <div class="col-lg-4">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control {{$errors->has('name_en')?'is-invalid':''}}" value="{{old('name_en')}}" name="name_en" type="text" placeholder="..name" id="example-text-input">
                           ...
                           <div class="col-lg-4">
                            ...
                            <input type="email" value="{{old('email')}}"  name="email" class="{{ $errors->has('email') ? 'is-invalid' : '' }} form-control">
                        ...
                        <div class="row mb3">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="url" value="{{old("preview_video")}}"  name="preview_video" class="{{ $errors->has('preview_video') ? 'is-invalid' : '' }} form-control">
                         ...
                         <div class="row mb3">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select   name="has_private_learning" class="{{ $errors->has('has_private_learning') ? 'is-invalid' : '' }} form-control" id="">
                                  <option value="1" {{ old('has_private_learning')=='1'?'selected':''  }}>نعم</option>
                                  <option value="0" {{ old('has_private_learning')=='0'?'selected':''  }}>لا</option>
                                </select>
                            ...
                            <div class="col-lg-6">
                                ...
                                <input  value="{{old("private_video")}}"  name="private_video" class="{{ $errors->has('private_video') ? 'is-invalid' : '' }} form-control">
