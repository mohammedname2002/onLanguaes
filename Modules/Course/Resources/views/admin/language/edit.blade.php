            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                       ...
                       <form action="{{route('admin.language.update',$lang->id)}}" method="POST" class="" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb3">
                           <div class="col-lg-6">
                            <label for="example-text-input"  class="col-sm-2 col-form-label">العنوان بالعربي</label>
                            <div class="col-sm-10">
                                <input class="form-control {{$errors->has('title_ar')?'is-invalid':''}}" value="{{$lang->title_ar}}" name="title_ar" type="text" placeholder="الإسم.." id="example-text-input">
                           ...
                           <div class="col-lg-6">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control {{$errors->has('title_en')?'is-invalid':''}}" value="{{$lang->title_en}}" name="title_en" type="text" placeholder="..title" id="example-text-input">
