...
@section('title_page','إضافة فيديو')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">إضافة فيديو</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">إضافة فيديو</h4>

                       <form action="{{route('admin.various.store')}}" method="POST" class="" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb3">
                            <div class="col-lg-6">
                        ...
                        <div class="row mb3">
                            <div class="col-lg-4">
                                <label for="example-text-input" class="col-sm-4 col-form-label">رابط الفيديو</label>
                                    ...
                                    value="{{ old('path') }}" name="path" type="text"
