...
@section('title','رفع صور للمنوعة')

@section('title_page','رفع صور للمنوعة')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">رفع صور للمنوعة</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">الصفحة الرئيسية</a></li>
                            <li class="breadcrumb-item active">رفع صور للمنوعة</li>
                        </ol>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row text-center">
                                                <div class="col-lg-4">
                                                    <a href="{{route('admin.various.attachment.download',[$various->id,$attachment->id])}}" class="btn btn-success"><i class="fa fa-download" aria-hidden="true"></i></a>

                                                </div>
                                                <div class="col-lg-4">
                                                    <form action="{{route('admin.various.attachment.delete',[$various->id,$attachment->id])}}" method="post">
                                                        @csrf
...
<script type="text/javascript">
    ...
    let resumable = new Resumable({
        target: '{{ route('admin.various.upload',$various->id) }}',
    ...
    resumable.on('fileSuccess', function (file, response) { // trigger when file upload complete
        ...
        $('#message').append("<a class='btn btn-sucesss' href='{{route('admin.various.index')}}'>الرجوع للخلف</a>");
        $('.card-footer').show();
        hideProgress();
