...
@section('title','رفع ملف للمحاضرة')

@section('title_page','رفع ملف للمحاضرة')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">رفع ملف للمحاضرة</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">الصفحة الرئيسية</a></li>
                            <li class="breadcrumb-item active">رفع ملف للمحاضرة</li>
                        </ol>
                    </div>
            ...
            <div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">مرفقات المحاضرة</h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row text-center">
                                                <div class="col-lg-4">
                                                    <a href="{{route('admin.lecture.attachment.download',[$lecture->id,$attachment->id])}}" class="btn btn-success"><i class="fa fa-download" aria-hidden="true"></i></a>

                                                </div>
                                                <div class="col-lg-4">
                                                    <form action="{{route('admin.lecture.attachment.delete',[$lecture->id,$attachment->id])}}" method="post">
                                                        @csrf
...
<script type="text/javascript">
    ...
    let resumable = new Resumable({
        target: '{{ route('admin.lecture.upload',$lecture->id) }}',
...
console.log(browseFile)
    ...
    resumable.on('fileSuccess', function (file, response) { // trigger when file upload complete
        ...
        $('#message').append("<a class='btn btn-sucesss' href='{{route('admin.lecture.index')}}'>الرجوع للخلف</a>");
        $('.card-footer').show();
        hideProgress();
