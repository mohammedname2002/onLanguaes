...
@section('title_page', 'تعديل محاضرة')
@push('css')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">تعديل محاضرة</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">الصفحة الرئيسية</a></li>
                                <li class="breadcrumb-item active">تعديل محاضرة</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">تعديل محاضرة</h4>

                            <form action="{{ route('admin.lecture.update',$lecture->id) }}" method="POST" class="" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}"
                                                value="{{ $lecture->title_ar }}" name="title_ar" type="text"
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control {{ $errors->has('title_en') ? 'is-invalid' : '' }}"
                                                value="{{ $lecture->title_en }}" name="title_en" type="text"
                                ...
                                <div class="row mb3">
                                    <div class="col-lg-12">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">الوصف
                                            ...
                                            <textarea class="elm1 {{ $errors->has('description_ar') ? 'is-invalid' : '' }}" name="description_ar" class="form-control">{{$lecture->description_ar}}</textarea>
                                    ...
                                    <div class="col-lg-12 mt-2">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">الوصف
                                            ...
                                            <textarea class="elm1 {{ $errors->has('description_en') ? 'is-invalid' : '' }}" name="description_en"  class="form-control">{{$lecture->description_en}}</textarea>
                                ...
                                <div class="row mb3">
                                    <div class="col-lg-4">
                                        <label for="example-text-input" class="col-sm-4 col-form-label">مدة المحاضرة</label>
                                            ...
                                            <input type="text" class="{{ $errors->has('duration') ? 'is-invalid' : '' }} form-control" name="duration"  value="{{$lecture->duration}}">
                                    ...
                                    <div class="col-lg-4">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">حالة الظهور</label>
                                            ...
                                            <select name="visiable" class="form-control" id="">
                                                <option value="1" {{$lecture->visiable=="1"?'selected':''}}>يظهر</option>
                                                <option value="0" {{$lecture->visiable=="0"?'selected':''}}>مخفي</option>
                                            </select>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="{{ $errors->has('lecture_link') ? 'is-invalid' : '' }} form-control" name="lecture_link"  value="{{$lecture->path_video}}">
                                ...
                                <div class="row mb3">
                                    ...
                                    <div class="col-lg-4">
                                        <label for="example-text-input" class="col-sm-4 col-form-label">نوع المحاضرة</label>
                                            ...
                                            <select name="type" class="{{ $errors->has('type') ? 'is-invalid' : '' }} form-control" id="">
                                                <option value="1" {{$lecture->type=="1"?'selected':''}}>مقفلة</option>
                                                <option value="0" {{$lecture->type=="0"?'selected':''}}>مجانية</option>
                                            </select>
                                            @if ($errors->has('type'))
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('type') }}
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="number" class="{{ $errors->has('order') ? 'is-invalid' : '' }} form-control" name="order"  value="{{$lecture->order}}">
                                    ...
                                    <div class="col-lg-4">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">الكورس</label>
                                            <select id="course"  name="course" class="{{ $errors->has('course') ? 'is-invalid' : '' }} form-control select2" id="">
                                                <option value="{{$lecture->course->id}}" selected>{{$lecture->course->title_ar}}</option>
                                            </select>
