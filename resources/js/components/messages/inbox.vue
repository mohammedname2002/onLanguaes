<template>
 <div class="row">
                ...
                <div class="email-rightbar mb-3">
                    ...
                    <div class="card">
                        <div class="btn-toolbar p-3" role="toolbar">
                            ...
                            <div class="btn-group me-2 mb-2 mb-sm-0"  v-if="usersids.length>0">
      ...
      no-enforce-focus   @click="showmessagemodal=true"  id="message-modal" centered size="lg" title="إنشاء رسالة">
                <template #modal-header>
                 <h5 class="modal-title">إنشاء رسالة</h5>
                </template>
                <form>
...
export default {
    ...
    methods:{
        ...
        SendMessageTo(){
            if(this.usersids.length > 0 && this.message.subject && this.message.type && this.message.content!='')
            {
               var data={
                    users:this.usersids,
                ...
                if(this.message.type=='website')
                data.sender_id=this.admin
