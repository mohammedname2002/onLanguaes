...
<head>
  ...
  <!-- Site Title -->
  <title>General Purpose Invoice-4</title>
  <style>
        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_top_head tm_mb20 tm_mb10_md">
            <div class="tm_invoice_left">
              <div class="tm_logo"><img src="{{ asset('assets/user/img/logo/main_logo.png')}}" alt="Logo"></div>
            </div>
            <div class="tm_invoice_right">
              <div class="tm_grid_row tm_col_3">
                <div class="tm_text_center">
                  ...
                  onlanguagecourses@gmail.com <br>
                  support@onlanguagecourses.com
                </div>
                <div class="tm_text_center">
                  <p class="tm_accent_color tm_mb0">
          ...
          <div class="tm_invoice_info tm_mb10">
            <div class="tm_invoice_info_left">
              ...
              <p>
                <b class="tm_f16 tm_primary_color">{{auth()->user()->name}}</b> <br>
              ...
              <div class="tm_grid_row tm_col_3 tm_invoice_info_in tm_round_border tm_gray_bg">
               ...
               @endphp
                <div>
                  ...
                  <b class="tm_f18 tm_accent_color">{{'#'.$rand.$payment->id }}</b>
                </div>
                <div>
                  <span>Invoice Date:</span> <br>
                  <b class="tm_f18 tm_accent_color">{{$payment->created_at->format('y-m-d')}}</b>
                </div>
                <div>
                  <span>Grand Total:</span> <br>
                  <b class="tm_f18 tm_accent_color">{{$payment->total}} $</b>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="tm_round_border">
              <div class="tm_table_responsive">
                <table>
                  ...
                  <tbody>
                    @foreach($payment->payments_details as $course)

                    <tr class="tm_gray_bg">
                      <td class="tm_width_7">
                        <p class="tm_m0 tm_f16 tm_primary_color">{{$course->course->title_en}}
                      </td>
                      <td class="tm_width_2">${{$course->price}}</td>
                    </tr>
                    @endforeach
                ...
                <table class="tm_mb15">
                  <tbody>
                    <tr>
                      ...
                      <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_bold">${{$payment->total}}</td>
                    </tr>


                    <tr>
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f18 tm_white_color tm_accent_bg tm_radius_6_0_0_6">Grand Total	</td>
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f18 tm_primary_color tm_text_right tm_white_color tm_accent_bg tm_radius_0_6_6_0">{{$payment->total}} $</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="tm_invoice_footer tm_type1">
              ...
              <div class="tm_right_footer">
                <div class="tm_sign tm_text_center">
                  <p class="tm_m0 tm_ternary_color">Hohaifa Ahmed</p>
          ...
          <div class="tm_bottom_invoice">
            <div class="tm_bottom_invoice_left">
              <p class="tm_m0 tm_f18 tm_accent_color tm_mb5">Thank you for your Dealing With Us.</p>
