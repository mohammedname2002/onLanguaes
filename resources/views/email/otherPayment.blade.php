...
<head>
  ...
  <!-- Site Title -->
  <title>Money Exchange Invoice</title>
      ...
      <div class="cs-invoice_in" id="download_section">
        <div class="cs-invoice_head cs-type1 cs-mb25">
          <div class="cs-invoice_left">
            <p class="cs-invoice_number cs-primary_color cs-mb0 cs-f25">Onlanguages Courses Company </p>
            @php
            $rand = substr(md5(microtime()),rand(0,26),5);

           @endphp

            <p class="cs-invoice_number cs-primary_color cs-mb0 cs-f16"><b class="cs-primary_color">Transection NO:</b>{{'#'.$rand.$payments->id }} </p>
          </div>
          <div class="cs-invoice_right cs-text_right">
            <div class="cs-logo cs-mb5"><img width="190px" height="110px" src="{{ asset('assets/user/img/logo/main_logo.png')}}" alt="Logo"></div>
          </div>
        </div>
        <div class="cs-invoice_head cs-mb10">
          <div class="cs-invoice_left">
            <b class="cs-primary_color">Exchange Confirmation</b>
            <p>
                @php
                $rand = substr(md5(microtime()),rand(0,26),5);
              ...
              Funded {{$payments->created_at->format('y-m-d')}} <br>
              Paid out {{$payments->created_at->format('y-m-d')}} <br>
              Transfer ID {{'#'.$rand.$payments->id }} <br>
            </p>
          </div>
          <div class="cs-invoice_right cs-text_right">
            <p>
        ...
        <div class="cs-heading cs-style1 cs-f18 cs-primary_color cs-mb20 cs-semi_bold">Transfer Overview</div>
        <ul class="cs-grid_row cs-col_2 cs-mb5">
          <li>
            <p class="cs-mb20">Ammount paid by.{{ $payments->name }} <br><span class="cs-primary_color"> ${{ $payments->price }} USD</span></p>

          </li>
          <li>
            <p class="cs-mb20">Fee <br><span class="cs-primary_color">$0 USD</span></p>
                  </li>
        </ul>
        <div class="cs-heading cs-style1 cs-f18 cs-primary_color cs-mb20 cs-semi_bold">Send To</div>
        <ul class="cs-grid_row cs-col_2 cs-mb20">
          <li>
            <p class="cs-mb5"><span class="cs-primary_color cs-semi_bold">Name:</span> Onlanguage Courses Company</p>
          </li>

        </ul>
        <div class="cs-heading cs-style1 cs-f18 cs-primary_color cs-mb20 cs-semi_bold">Paid Out From</div>
        <ul class="cs-grid_row cs-col_2 cs-mb5">
          <li>
            <p class="cs-mb5"><span class="cs-primary_color cs-semi_bold">Name:</span>  {{ $payments->name }}</p>
          </li>
