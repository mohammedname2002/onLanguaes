...
<header>
    ...
    <div class="actions">
        <a class="btn" href="{{url(config('user-activity.admin_panel_path'))}}">العودة للوحة التحكم</a>
    </div>
</header>
<section class="content">
    ...
    <div class="popup_wrapper" ng-show="popup">
        <div class="popup" style="width: 60%">
            ...
            <div class="footer">
                <div>
                  <a ng-show="selected.log_type==='edit'" href="@{{selected.json_data['url']}}" class="btn btn-primary mt-2 mb-4">الذهاب إلى التعديل</a>
                </div>
                <div>
